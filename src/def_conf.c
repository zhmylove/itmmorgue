...
struct t_conf_default t_conf_default[] = {
    ...
    C_INT("win_chat_small_x", 50),
    C_INT("win_chat_small_x_ispercent", 0),
    C_INT("win_chat_small_max_y", 2),
    C_INT("win_chat_small_max_y_ispercent", 0),
    C_INT("win_chat_small_max_x", 30),
    C_INT("win_chat_small_max_x_ispercent", 0),
    C_INT("win_chat_large_y", 0),
    C_INT("win_chat_large_y_ispercent", 0),
    C_INT("win_chat_large_x", 0),
    C_INT("win_chat_large_x_ispercent", 0),
    C_INT("win_chat_large_max_y", 0),
    C_INT("win_chat_large_max_y_ispercent", 0),
    C_INT("win_chat_large_max_x", 0),
    C_INT("win_chat_large_max_x_ispercent", 0),
    ...
    C_INT("win_sysmsg_large_max_y", 0),
    C_INT("win_sysmsg_large_max_y_ispercent", 0),
    C_INT("win_sysmsg_large_max_x", 0),
    C_INT("win_sysmsg_large_max_x_ispercent", 0),
